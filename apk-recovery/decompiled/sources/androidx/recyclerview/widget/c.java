...
public class c extends m {
    ...
    public void j(RecyclerView.c0 c0Var) {
        ...
        while (true) {
            ...
            if (size < 0) {
                break;
            } else if (((j) this.j.get(size)).a == c0Var) {
    ...
    public void u() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                if (z) {
                    p51.d0(((j) arrayList.get(0)).a.a, aVar, o());
                } else {
                    aVar.run();
                }
            }
            if (z3) {
                ...
                if (z) {
                    p51.d0(((i) arrayList2.get(0)).a.a, bVar, o());
                } else {
                    bVar.run();
                }
            }
            if (z4) {
                ...
                if (z || z2 || z3) {
                    p51.d0(((RecyclerView.c0) arrayList3.get(0)).a, runnableC0054c, (z ? o() : 0L) + Math.max(z2 ? n() : 0L, z3 ? m() : 0L));
                } else {
                    runnableC0054c.run();
                }
            }
