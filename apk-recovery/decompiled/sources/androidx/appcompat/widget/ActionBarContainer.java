...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, pn0.a);
        this.e = obtainStyledAttributes.getDrawable(pn0.b);
        this.f = obtainStyledAttributes.getDrawable(pn0.d);
        this.j = obtainStyledAttributes.getDimensionPixelSize(pn0.i, -1);
        boolean z = true;
        if (getId() == nm0.n) {
            this.h = true;
            this.g = obtainStyledAttributes.getDrawable(pn0.c);
        }
    ...
    public void onFinishInflate() {
        ...
        this.c = findViewById(nm0.a);
        this.d = findViewById(nm0.f);
    }
