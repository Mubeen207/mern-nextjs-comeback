...
public class DialogTitle extends l3 {
    ...
    public void onMeasure(int i, int i2) {
        ...
        setSingleLine(false);
        setMaxLines(2);
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(null, pn0.D1, 16842817, 16973892);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(pn0.E1, 0);
