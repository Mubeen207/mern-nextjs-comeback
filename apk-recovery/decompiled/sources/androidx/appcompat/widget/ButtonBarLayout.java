...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        this.c = -1;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, pn0.m0);
        p51.i0(this, context, pn0.m0, attributeSet, obtainStyledAttributes, 0, 0);
        this.a = obtainStyledAttributes.getBoolean(pn0.n0, true);
    ...
    private void setStacked(boolean z) {
        if (this.b != z) {
            if (!z || this.a) {
                ...
                View findViewById = findViewById(nm0.m);
    ...
    */
    public void onMeasure(int r6, int r7) {
        ...
        L98:
            ...
            int r2 = r4 + r0
        L9e:
            int r0 = androidx.appcompat.view.menu.p51.y(r5)
            if (r0 == r2) goto Lac
