...
public final class h8 {
    ...
    static {
        ...
        g = new h8(false, 2, wz0Var);
        h = new h8(true, 2, wz0Var);
    }

    public h8(boolean z, int i, wz0 wz0Var) {
        this.a = z;
        this.b = i;
        this.c = wz0Var;
    }
    ...
    public final String f(CharSequence charSequence, wz0 wz0Var) {
        boolean a2 = wz0Var.a(charSequence, 0, charSequence.length());
        return (this.a || !(a2 || b(charSequence) == 1)) ? this.a ? (!a2 || b(charSequence) == -1) ? f : "" : "" : e;
    }

    public final String g(CharSequence charSequence, wz0 wz0Var) {
        boolean a2 = wz0Var.a(charSequence, 0, charSequence.length());
    ...
    public CharSequence i(CharSequence charSequence, wz0 wz0Var, boolean z) {
        ...
        if (d() && z) {
            spannableStringBuilder.append((CharSequence) g(charSequence, a2 ? xz0.b : xz0.a));
        }
        if (a2 != this.a) {
        ...
        if (z) {
            spannableStringBuilder.append((CharSequence) f(charSequence, a2 ? xz0.b : xz0.a));
        }
    ...
    public String k(String str, wz0 wz0Var, boolean z) {
        if (str == null) {
            return null;
        }
        return i(str, wz0Var, z).toString();
    }
}
