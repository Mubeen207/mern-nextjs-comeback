...
public abstract class k5 implements View.OnTouchListener {
    ...
    public static class a {
        ...
        public final float e(long j) {
            ...
            long j3 = this.i;
            if (j3 < 0 || j < j3) {
                return k5.e(((float) (j - j2)) / this.a, 0.0f, 1.0f) * 0.5f;
            }
            float f = this.j;
            return (1.0f - f) + (f * k5.e(((float) (j - j3)) / this.k, 0.0f, 1.0f));
        }
    ...
    */
    public boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L1e:
            ...
            androidx.appcompat.view.menu.k5$a r7 = r5.a
            r7.l(r0, r6)
            boolean r6 = r5.o
            if (r6 != 0) goto L58
            boolean r6 = r5.u()
        ...
        L61:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.view.menu.k5.onTouch(android.view.View, android.view.MotionEvent):boolean");
    }
