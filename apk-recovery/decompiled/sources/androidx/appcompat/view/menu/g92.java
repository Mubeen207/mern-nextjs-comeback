...
public interface g92 {
    ...
    void C(int i, List list, m52 m52Var);
    ...
    void b(int i, List list, m52 m52Var);
    ...
    void m(int i, Object obj, m52 m52Var);

    void n(int i, List list, boolean z);

    void o(int i, List list, boolean z);

    void p(int i, p32 p32Var, Map map);
    ...
    void u(int i, Object obj, m52 m52Var);

    void v(int i, List list, boolean z);

    void w(int i, List list, boolean z);

    void x(int i, tx1 tx1Var);

    void y(int i, List list);
