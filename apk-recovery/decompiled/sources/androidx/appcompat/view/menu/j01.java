...
public abstract class j01 {
    ...
    public static void a(View view, Context context) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(pn0.k0);
        try {
            if (!obtainStyledAttributes.hasValue(pn0.l0)) {
    ...
    public static int d(Context context, int i2, float f2) {
        int c2 = c(context, i2);
        return cd.k(c2, Math.round(Color.alpha(c2) * f2));
    }
