...
public class ew extends fw {
    ...
    public class c implements Transition.TransitionListener {
        ...
        public void onTransitionStart(Transition transition) {
            Object obj = this.a;
            if (obj != null) {
                ew.this.D(obj, this.b, null);
            }
            Object obj2 = this.c;
            if (obj2 != null) {
                ew.this.D(obj2, this.d, null);
            }
            Object obj3 = this.e;
            if (obj3 != null) {
                ew.this.D(obj3, this.f, null);
            }
        }
    }
    ...
    public static boolean C(Transition transition) {
        return (fw.l(transition.getTargetIds()) && fw.l(transition.getTargetNames()) && fw.l(transition.getTargetTypes())) ? false : true;
    }
    ...
    public void b(Object obj, ArrayList arrayList) {
        ...
        } else if (C(transition) || !fw.l(transition.getTargets())) {
        } else {
    ...
    public void z(Object obj, View view, ArrayList arrayList) {
        ...
        int size = arrayList.size();
        for (int i = 0; i < size; i++) {
            fw.f(targets, (View) arrayList.get(i));
        }
        targets.add(view);
        arrayList.add(view);
