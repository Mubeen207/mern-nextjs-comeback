...
import androidx.appcompat.view.menu.dy;
import androidx.appcompat.view.menu.ef;
import androidx.appcompat.view.menu.gy;
...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    public final void b() {
        ...
        if (pendingIntent == null && num == null) {
            ...
            dy.m().n(this, ((Integer) pj0.i(num)).intValue(), 2, this);
            this.a = 1;
        } else {
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    gy.x(this).F(new ef(22, null), getIntent().getIntExtra("failing_client_id", -1));
                } else {
